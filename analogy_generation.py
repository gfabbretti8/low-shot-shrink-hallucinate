...
def train_analogy_regressor(analogies, centroids, base_classes, trained_classifier, lr=0.1, wt=5, niter=8000, step_after=40000, batchsize=128, momentum=0.9, wd=0.0001):
